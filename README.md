...
[![GitHub Issues](https://img.shields.io/github/issues/svelte-websocket-store/svelte-websocket-store.svg?style=flat-square)](https://github.com/svelte-websocket-store/svelte-websocket-store/issues)
[![Build Status](https://img.shields.io/endpoint.svg?url=https%3A%2F%2Factions-badge.atrox.dev%2Fsvelte-websocket-store%2Fsvelte-websocket-store%2Fbadge\&style=flat)](https://actions-badge.atrox.dev/svelte-websocket-store/svelte-websocket-store/goto)
[![Styled with prettier](https://img.shields.io/badge/styled_with-prettier-ff69b4.svg)](https://github.com/prettier/prettier)
[![Commitizen friendly](https://img.shields.io/badge/commitizen-friendly-brightgreen.svg)](http://commitizen.github.io/cz-cli/)
[![Known Vulnerabilities](https://snyk.io/test/github/svelte-websocket-store/svelte-websocket-store/badge.svg)](https://snyk.io/test/github/svelte-websocket-store/svelte-websocket-store)
[![Coverage Status](https://coveralls.io/repos/svelte-websocket-store/svelte-websocket-store/badge.svg)](https://coveralls.io/github/svelte-websocket-store/svelte-websocket-store)
